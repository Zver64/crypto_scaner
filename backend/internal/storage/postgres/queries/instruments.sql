...
ORDER BY
  CASE WHEN sqlc.arg(sort_direction)::text = 'asc' THEN market_cap.market_cap_usd END ASC NULLS LAST,
  CASE WHEN sqlc.arg(sort_direction)::text = 'desc' THEN market_cap.market_cap_usd END DESC NULLS LAST,
