...
export type LiveCandleServerMessageFreshness = typeof LiveCandleServerMessageFreshness[keyof typeof LiveCandleServerMessageFreshness];


export const LiveCandleServerMessageFreshness = {
  waiting: 'waiting',
  fresh: 'fresh',
  stale: 'stale',
